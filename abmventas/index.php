...
<body id="page-top">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">ABM ventas</h1>
          <a href="ventasinforme.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
              ...
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Peticiones pendiente</div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 mb-4">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <h4 class="small font-weight-bold">Migración de Servicio <span class="float-right">20%</span></h4>
                ...
                <h4 class="small font-weight-bold">Ajustes de Cuenta <span class="float-right">Completado!</span></h4>
                <div class="progress">
